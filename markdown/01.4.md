...
The below grid shows the two goals I have set for myself; one to be completed within ten years and the other within three weeks.
...
-|-|-|-
Familiarise myself with the project, as I haven't had time to work on it for some time. | Read through the source code I've already written, and potentially make some readability improvements. | Being more familiar with the code I previously wrote, in order that I can continue development easily. | 7<sup>th</sup> February
...
### Entry Two: day <sup>th</sup> February
