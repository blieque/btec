...
From this I was able to identify that I may benefit from further developing my skills in *programming and coding* and therefore specialising, but also from working on the attributes which were lower rated, such as *networking/semi-formal communication* and *work experience*.
...
> You may also want to include a reflective project evaluation. This should include an analysis of at least some of the following questions:
> * Did your personal development plan achieve its aims?
> * What worked well, and what didn't work so well on your project?
> * If you were to do this project all over again, what would you do differently?
> * What methods would you use again in future projects of this kind?
> * What will be your next step towards your long-term goal
> Your evaluation should take the form a detailed report (min. 1500 words)

> D2: the overall review of your short-term plan should take the form of a report (min. 1500 words), written in either.doc, .docx, .rtf or .pdf formats.You can draw liberally evidence from your project diary, and include relevant samples or screenshots of work produced over the course of your project.
...
If I were to complete the project again...
...
What could be used again? Methods, techniques, etc.

* PHP + MySQL
* AJAX
* Workflow: ST2,Vim + local nginx + git(hub) -> debian vps, nginx, ssl

### The Future

What now? -> long-term goals
Conclude

* maintain
* make more
* roll in fat stax
* all good, pretty much -> needs more (but deffo is finished)