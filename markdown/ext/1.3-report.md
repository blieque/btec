...
Libraries specific to the platform allow developers to focus on the parts of their software applications that are unique. By including libraries that are built and optimised for certain devices leads to easier and quicker development; standards held across great ranges of software; and a more consistent end-user experience.
