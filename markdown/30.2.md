...
<div class="i">
	...
	The first version of the poster I created. Click the poster for a full size version.
	<div>Image by me; see <a href="/btec/license">license</a>.</div>
</div>
...
* Clouds &ndash; [commons.wikimedia.org](http://commons.wikimedia.org/wiki/File%3ACumulus_clouds_21072012_%281%29.jpg) (used in [logo redesign](#4))
...
<div class="i r">
	...
	<div>Image by me; see <a href="/btec/licence">license</a>.</div>
</div>
...
<div class="i">
	<a href="/btec/img/30.2.6.2.jpg"><img src="/btec/img/30.2.6.1.jpg"></a>
	The altered poster, changed after having received feedback from people in class. I added the logos for Steam, the PlayStation 4 and the Xbox One, showing the three platforms that the game would be released on. The revised logo shown below was also added. Again, you click the image for a full-size version.
	<div>Image by me; see <a href="/btec/license">license</a>.</div>
</div>
<div class="i">
	<img src="/btec/img/30.2.6.3.png">
	The altered logo, with mist/smoke added as per suggestion. I used the brush tool, clipping masks and cloud rendering to achieve the effect. I also used a photo of cumulus clouds, mentioned previously.
	<div>Image by me; see <a href="/btec/license">license</a>.</div>
</div>
